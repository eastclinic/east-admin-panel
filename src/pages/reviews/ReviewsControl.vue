...
<EditDialog v-model:visible="visibleEditDialog" v-model="editData" @updated:review="refreshReviewRow" @created:review="refreshReviews"  @deleted:review="refreshReviews"></EditDialog>
    <div class="grid">
        <div class="col-12">
            <div class="card">
                <DataTable
